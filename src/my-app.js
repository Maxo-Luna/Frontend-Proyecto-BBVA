    ...
    return html`
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          ...
          >
            <span id="Menu">
            <a name="cuenta" href="[[rootPath]]cuenta">Operaciones</a>
            <a name="cotizacion" href="[[rootPath]]cotizacion">Consulta la cotización</a>
            <a name="logoff" href="[[rootPath]]logoff">Cerrar sesión</a>
            </span>
          </iron-selector>
        </app-drawer>
